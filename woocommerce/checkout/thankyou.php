      ...
      <div class="col-md-12">
         <div class="tutorstarter-order-receipt-container" style="margin-top: 40px;">
            <div class="woocommerce-order">
               ...
               <?php else : ?>
               <p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', esc_html__( 'Thank you. Your order has been received.', 'tutorstarter' ), $order ); ?></p>
               ...
               <?php else : ?>
               <p class="woocommerce-notice woocommerce-notice--success woocommerce-thankyou-order-received"><?php echo apply_filters( 'woocommerce_thankyou_order_received_text', esc_html__( 'Thank you. Your order has been received.', 'tutorstarter' ), null ); ?></p>
               <?php endif; ?>
            </div>
         </div>
      </div>
